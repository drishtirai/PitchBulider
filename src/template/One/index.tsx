    ...
    render() {
        ...
        return (
            <div className={styles.insideCon}>
                <div>
                    <Text value={this.props.userData.name} statename="userData.name" placeholder="ONE MIN PITCH" customclass={styles.name} />
                </div>
                ...
                {itemStatus.info && (
                    <div className={[styles.info, styles.box].join(' ')}>
                        <Text
                            ...
                            tag="div"
                        />
                        <Text value={this.props.userData.address} statename="userData.address" placeholder="_____Name of company_____________ is developing _____a defined offerig ______________ to help______a defined audience solve a problem___________ with ________secret sause_____________" />
                        <Text value={this.props.userData.email} statename="userData.email" placeholder="" />
                        <Text value={this.props.userData.mobile} statename="userData.mobile" placeholder="" />
                        <Text value={this.props.userData.userData} statename="userData.userData" placeholder="" />
                    </div>
                )}
                ...
                {itemStatus.profile && (
                    <div className={[styles.profile, styles.box].join(' ')}>
                        ...
                        <Text
                            ...
                            placeholder="We compete in the growing__________defined _______________ valve market"
                        />
                    </div>
                )}
