        ...
        <Dnd2Column
            ...
            renderItem={(item) => (
                <div style={{ background: '#fff' }}>
                    <Text value={item.title} statename="skills.title" stateid={item.id} placeholder="currently we have_____current state of product or company____________________" />
                </div>
            )}
        />
    );
